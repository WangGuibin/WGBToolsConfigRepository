...
#
# #
# AppStore Release 下 APPID "bf9f34accb"，Test 下 AppID fe0eaed005
BUGLY_APP_ID=$1
echo "BUGLY_APP_ID: $1";
# #
# AppStore Release 下 APP_KEY "ab6d8e64-49cc-4e81-9b6f-1effb871f796"，Test 下 APP_KEY eb074f17-7b56-4a51-b906-9bdfa1fe4959
BUGLY_APP_KEY=$2
echo "BUGLY_APP_KEY: $2";
# #
# AppStore Release 下 BundleID "com.weimai.vmy", Test 下 BundleID com.weimai.vmy.test
BUNDLE_IDENTIFIER=$3;
...
if [ ! -f "${BUGLY_SYMBOL_JAR_PATH}" ]; then
    BUGLY_SYMBOL_JAR_PATH="$PWD/Scripts/Bugly/buglySymboliOS.jar"
fi
